...
defined('TRANSFER_CATEGORY_CASHROOM')       OR define('TRANSFER_CATEGORY_CASHROOM', 5);
defined('TRANSFER_CATEGORY_BLACKBOX')       OR define('TRANSFER_CATEGORY_BLACKBOX', 6);
defined('TRANSFER_CATEGORY_PAX_ISSUANCE')   OR define('TRANSFER_CATEGORY_PAX_ISSUANCE', 7);
defined('TRANSFER_CATEGORY_CASH_EXCHANGE')  OR define('TRANSFER_CATEGORY_CASH_EXCHANGE', 8);
defined('TRANSFER_CATEGORY_CSC_APPLICATION') OR define('TRANSFER_CATEGORY_CSC_APPLICATION', 9);
