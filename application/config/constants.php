...
defined('SALE_ITEM_PENDING')	OR define('SALE_ITEM_PENDING', 30);
defined('SALE_ITEM_RECORDED')	OR define('SALE_ITEM_RECORDED', 31);
defined('SALE_ITEM_VOIDED')	    OR define('SALE_ITEM_VOIDED', 32);
