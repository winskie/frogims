...
class Store extends Base_model
{
	...
	public function get_transactions_date_range( $params = array() )
	{
		$start_time = param( $params, 'start', date( TIMESTAMP_FORMAT, strtotime( 'now - 1 day' ) ) );
        $end_time = param( $params, 'end', date( TIMESTAMP_FORMAT ) );
	...
	public function get_inventory_as_of( $params = array() )
	{
		//TODO: Add initial balance transaction on installer
		
        $date = param( $params, 'date', date( TIMESTAMP_FORMAT ) );
