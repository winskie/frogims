...
class Allocation extends Base_model {
    ...
    public function _check_items()
    {
        ...
        foreach( $allocations as $allocation )
        {
            ...
            if( ! $category )
            {
                die( 'Missing allocation category' );
                return FALSE;
            }
            ...
            switch( $this->allocation_status )
            {
                case ALLOCATION_SCHEDULED:
                    ...
                    {
                        die( 'Not an allocation category' );
                        return FALSE;
                    }
                    ...
                    {
                        die( 'Not included in pre-allocation categories' );
                        return FALSE;
                    }
                    ...
                    {
                        die( 'Not allowed allocation item status' );
                        return FALSE;
                    }
                    ...
                    {
                        die( 'Empty or negative allocated quantity' );
                        return FALSE;
                    }
                    break;
        ...
        foreach( $remittances as $remittance )
        {
            ...
            if( ! $category )
            {
                die( 'Missing remittance category' );
                return FALSE;
            }
            
            if( ! $item )
            {
                die( 'Missing remittance item' );
                return FALSE;
            }
            ...
            switch( $this->allocation_status )
            {
                case ALLOCATION_SCHEDULED:
                    ...
                    die( 'There should not be any remittances during this allocation status' );
                    return FALSE;
                    break;
