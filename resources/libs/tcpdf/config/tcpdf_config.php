 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'TMIS');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'TMIS');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Light Rail Transit Authority');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Fare Revenue Operations Group");
